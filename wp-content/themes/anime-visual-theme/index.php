...
?>
		        				<li class="ui-tabs-nav-item" id="nav-fragment-<?php the_ID(); ?>">
		        					...
		        					<img src="<?php bloginfo('template_url'); ?>/thumb.php?src=<?php echo get_post_meta($post->ID, 'postimage', $single = true); ?>&amp;w=50&amp;h=44&amp;zc=1&amp;q=100" alt="" />
		        					</a>
		        				</li>
<?php
							endwhile;
...
<?php
							if( get_post_meta($post->ID, "postimage", true) ): ?>
								<a href="<?php the_permalink() ?>" rel="bookmark">
									<img src="<?php bloginfo('template_url'); ?>/thumb.php?src=<?php echo get_post_meta($post->ID, 'postimage', $single = true); ?>&amp;w=70&amp;h=70&amp;zc=1&amp;q=100" class="latestpostimage" alt="<?php the_title(); ?>" />
								</a>
<?php
							else: ?>
						   		<a href="<?php the_permalink() ?>" rel="bookmark">
						   			<img class="latestpostimage" src="<?php bloginfo('template_url'); ?>/images/postimage.png" alt="<?php the_title(); ?>" />
						   		</a>
<?php
							endif;
?>
...
?>
		<div id="leftposts"><?php $recent = new WP_Query("cat=".$ani_featured_left."&showposts=2");
...
?>
							<a href="<?php the_permalink() ?>" rel="bookmark">
								<img src="<?php bloginfo('template_url'); ?>/thumb.php?src=<?php echo get_post_meta($post->ID, 'postimage', $single = true); ?>&amp;w=70&amp;h=70&amp;zc=1&amp;q=100" class="postimage" alt="<?php the_title(); ?>" />
							</a>
<?php
						else: ?>
					   		<a href="<?php the_permalink() ?>" rel="bookmark"><img class="postimage" src="<?php bloginfo('template_url'); ?>/images/postimage.png" alt="<?php the_title(); ?>" /></a>
<?php
						endif;
?>
<?php
...
<?php
							...
							<div class="alignrightmore"><a href="<?php the_permalink() ?>">More</a>
							</div>
						</div>
						</div>
						</div>
...
?>
					   		<a href="<?php the_permalink() ?>" rel="bookmark">
					   			<img class="postimage" src="<?php bloginfo('template_url'); ?>/images/postimage.png" alt="<?php the_title(); ?>" />
					   		</a>
<?php
						endif;
?>
						...
						<div style="width:240px;">
							<div class="alignleftcomments">
								<?php comments_popup_link('Add comment', '1 Comment', '% Comments', 'commentsbutton', ''); ?>
							</div>
							<div class="alignrightmore"><a href="<?php the_permalink() ?>">More</a></div>
						</div>
					</div>
				</div>
			</div>
