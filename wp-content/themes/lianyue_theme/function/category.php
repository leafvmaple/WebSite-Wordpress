...
function category_blog()
{
	...
	while (have_posts()) : the_post();
		...
		$blog.= '<h3><a href="'.get_permalink().'" '.post_color().' title="'.get_the_title().'" rel="bookmark">';
		$blog.= get_the_title().'</a></h3>';
		$blog.= '<div class="excerpt">';
		$blog.= '<a href="'.get_permalink().'" title="'.get_the_title().'" rel="bookmark">';
...
function category_list()
{
	...
	while (have_posts()) : the_post();
		...
		$list.= '<h3><a href="'.get_permalink().'" '.post_color().' title="'.get_the_title().'" rel="bookmark">';
...
function category_image()
{
	...
	while (have_posts()) : the_post();
		if($i%6>=3)
			...
			$image.= '<li>';
		$image.='<a href="'.get_permalink().'" '.post_color().' title="'.get_the_title().'" rel="bookmark">';
